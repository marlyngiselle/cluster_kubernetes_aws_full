...
kubeadm init --apiserver-advertise-address=192.168.56.10 --pod-network-cidr=192.168.0.0/16 --cri-socket unix:///var/run/containerd/containerd.sock | tee /root/cluster_inicializacion.log
...
echo "[ INICIAR CLUSTER | PASO 5.1] Configurar permisos a usuario ROOT para poder ejecutar comandos kubectl"
export KUBECONFIG=/etc/kubernetes/admin.conf
echo "export KUBECONFIG=/etc/kubernetes/admin.conf" | tee -a ~/.bashrc
source ~/.bashrc

echo "[ INICIAR CLUSTER | PASO 5.2] Configurar permisos a USUARIO VAGRANT para poder ejecutar comandos kubectl"
mkdir -p /home/vagrant/.kube
cp -i /etc/kubernetes/admin.conf /home/vagrant/.kube/config
chown vagrant:vagrant /home/vagrant/.kube/config

# echo "[ INICIAR CLUSTER | PASO 5.3] Configurar permisos a USUARIO ANSIBLE para poder ejecutar comandos kubectl"
...
echo "[ INICIAR CLUSTER | PASO 6] Crear alias 'kubectl' para usuario ROOT"
...
echo "[ INICIAR CLUSTER | PASO 6.1] Crear alias kubectl para usuario VAGRANT"
